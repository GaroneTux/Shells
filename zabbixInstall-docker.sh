#!/bin/bash
#########################################################################
# Criação de Ambiente Zabbix com Docker -Images: Ubuntu.		#
# Nome: docker-zabbix.sh                                                #
# Autor: Etore Garone garone.tux@gmail.com			        #
# Data: 07/2018	                                                        #
# Descrição: Criação de enviroment Zabbix em Docker.			#
#         >>> Verifique Variaveis antes <<<			        #
#                                                                       #
#########################################################################
...
ZABBIX_DB_USER_PASSWORD="zabbix"
SERVER_IP="10.999.999.75"
